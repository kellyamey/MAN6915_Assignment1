...
print(str(input_string)+ " has " + str(len(input_string)) + " characters.")
...
print("The "+ str(adjective) + " " + str(noun) + " " + str(adverb) + " " + str(verb) + " in the Summertime! Hilarious!")
...
print(str(number_1) + " + " + str(number_2) + " = " + str(sum_of_numbers) + '\n'
      + str(number_1) + " - " + str(number_2) + " = " + str(difference_of_numbers) + '\n'
      + str(number_1) + " * " + str(number_2) + " = " + str(product_of_numbers) + '\n'
      + str(number_1) + " / " + str(number_2) + " = " + str(quotient_of_numbers))
...
print("You have " + str(years_left) + " years left until you can retire." + '\n'
      + "It's " + str(now.year) + ", so you can retire in " + str(retirement_year) + ".")
...
print("You entered dimensions of " + str(length_of_room_feet) + " feet by " + str(width_of_room_feet) + " feet." + '\n'
      + "The area is" + '\n'
      + str(square_feet) + " square feet, which is" + '\n'
      + str(square_meters) + " square meters.")
...
#Calculate the slices_per_person using the floor division operator, //
slices_per_person = (slices_per_pizza*number_of_pizzas) // number_of_people

#Calculate the leftover_slices using the modulus operator, %
leftover_slices = (slices_per_pizza*number_of_pizzas) % number_of_people

#Print output, confirming inputs, how many slices each person gets, and how many leftover slices remain. Use line breaks
print(str(number_of_people) + " people with " + str(number_of_pizzas) + " pizzas." + '\n'
      + "Each person gets " + str(slices_per_person) + " slices of pizza." + '\n'
      + "There are " + str(leftover_slices) + " leftover slices of pizza.")
...
print("You will need to purchase " + str(purchased_gallons) + " gallons of" + '\n'
      + "paint to cover " + str(sf_ceiling) + " square feet.")
...
print("After " + str('{:.0f}'.format(number_of_years)) + " years at " + str(per_interest_rate) + "%, the investment will" + '\n'
      + "be worth $" + str('{:.2f}'.format(rounded_investment_worth)) + ".")